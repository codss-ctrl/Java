...
public class ProductTest_01 {
	public static void main(String[] args) {
		Computer c1 = new Computer(200, "c1",100);
		HandPhone h1 = new HandPhone(100, "h1",100);
		Styler s1 = new Styler(400, "s1",100);
		
		Buyer b = new Buyer("손1", 10000);
...
//			Buyer b = 
//			sum = p.price*count;
//			System.out.print("\t"+p.name+"  "+p.price+ "만원"+count+"개 ");
			System.out.println();
		}
		System.out.println();
...
//		}
	...
	Vector<Product> product = new Vector<>();
		public boolean addProduct(Product p) {
			Product p1 = new Product(p.price, p.name,p.count);
