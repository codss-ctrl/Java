...
public class OOP_01 {
	public static void main(String[] args) {
		...
		/*
		OOP(Object-Oriented_Programming) - 객체지향 프로그래밍
		...
		3. 인스턴스란?
		 ...
		 - Tv 클래스로부터 만들어진 객체형을 Tv클래스의 인스턴스라고 한다.  
		 - 인스턴스 선언 방법
		    클래스명 변수명; // 클래스 타입의 참조변수 선언
		    변수명=new class명(); //클래스의 객체를 생성 후 객체의 주소를 참조변수에 저장 
		...
		4. 선언위치에 따른 변수의 위치
		 ...
		 - 인스턴스변수
		  : 클래스의 영역에 선언되며, 클래스의 인스턴스가 생성될때 같이 만들어 진다.
		  : 인스턴스 변수들의 값을 읽어 놓거나 저장하기 위해서는 인스턴스를 먼저 생성해야 한다.
		 ...
		 - 지역변수
		  : 메서드 내에 선언되며 해당 메서드 내에서만 사용가능하다.
		  : 메서드 종료시 소멸되게 된다.
